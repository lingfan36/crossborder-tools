    ...
    <>
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <article>
          ...
          <div 
            className="prose prose-lg max-w-none prose-headings:text-gray-800 prose-a:text-amber-600 prose-a:no-underline hover:prose-a:underline prose-table:border-collapse prose-th:bg-gray-800 prose-th:text-white prose-th:px-4 prose-th:py-2 prose-td:border prose-td:border-gray-200 prose-td:px-4 prose-td:py-2"
